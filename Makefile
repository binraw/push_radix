...
DIR_OBJ = .object/
RM = rm -Rf
SRCS = lst_create.c main.c radix.c swap_command.c lst_utils.c threenum.c fivenum.c finder.c big_lst_algo.c check.c  rotation.c check_error.c rotation_utils.c
